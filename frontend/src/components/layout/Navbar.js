...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full backdrop-blur-md z-50 text-[#dcc7b0] transition-colors duration-300 ${scrolled ? 'bg-[rgba(13,13,13,0.85)]' : 'bg-[rgba(13,13,13,0.3)]'}`}>
